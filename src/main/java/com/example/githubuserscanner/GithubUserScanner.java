...
/**
 * A command-line tool for fetching and displaying GitHub user information.
 * <p>
 * This class connects to the GitHub API to fetch a list of users, displays
 * their IDs,
 * and allows the user to query details for specific user IDs. It provides
 * details such as
 * login name, profile link, number of repositories, followers, and following
 * users.
 * </p>
 */
public class GithubUserScanner {
    ...
    /**
     * The main entry point of the program. Initializes the HTTP client, fetches a
     * list of users, displays available user IDs, and processes user input to
     * display user
     * details.
     *
     ...
     * @throws Exception if an error occurs while fetching or processing the data
     */
    ...
    /**
     * Fetches and updates details for a specific user.
     *
     * @param httpClient the HTTP client used to make the request
    ...
    /**
     * Prints the details of a user.by ID
     *
     * @param user the {@link User} object whose details are to be printed
     */
